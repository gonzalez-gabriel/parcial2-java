...
public class ControladorPrincipal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(gp.crearProducto(2, "Matambre", 20, Categoria.PLATOPRINCIPAL, Estado.DISPONIBLE));
        System.out.println(gp.crearProducto(3, "Flan", 30, Categoria.POSTRE, Estado.DISPONIBLE));
        System.out.println(gp.crearProducto(4, "asado", 40, Categoria.PLATOPRINCIPAL, Estado.DISPONIBLE));
        System.out.println(gp.menu());
        
        System.out.println("\nUsuarios");
        GestorUsuarios gu = GestorUsuarios.instanciar();
        System.out.println(gu.crearUsuario("usuario1@gmail.com", "Apellido1", "nombre4", Perfil.CLIENTE, "clave1", "clave1"));
        System.out.println(gu.crearUsuario("usuario2@gmail.com", "Apellido2", "nombre3", Perfil.CLIENTE, "clave2", "clave2"));
        System.out.println(gu.crearUsuario("usuario3@gmail.com", "Apellido2", "nombre1", Perfil.CLIENTE, "clave3", "clave3"));
        System.out.println(gu.crearUsuario("usuario4@gmail.com", "Apellido3", "nombre4", Perfil.CLIENTE, "clave4", "clave4"));
