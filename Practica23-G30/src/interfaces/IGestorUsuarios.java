...
public interface IGestorUsuarios {
    ...
    public static final String EXITO_CREADO = "Usuario creado con éxito";
    public static final String EXITO_MODIFICADO = "Usuario modificado con éxito";
    public static final String EXITO_BORRADO = "Se borro el usuario";
